...
// Também existe outra forma de verificar, caso o número de errado, você pode, em vez de definir outro if, utilizar do elemento else, que dá um resultado quando todas as condições pré-definidas dão errado.
idade = 14;
idadeIrmão = 30;
if (idadeIrmão - idade == 12) {
  let diferenca = '12 anos';
